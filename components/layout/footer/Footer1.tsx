					...
					<div className="container position-relative z-1">
						<div className="text-center">
							<Link className="d-flex main-logo align-items-center d-inline-flex" href="/">
								...
								<span className="fs-4 ms-2 text-white-keep">fuad.hasan</span>
							</Link>
						...
						<div className="row text-center py-4">
							<span className="fs-6 text-white-keep">© {new Date().getFullYear()} All Rights Reserved by <span><Link href="/#" className="text-primary">fuad.hasan</Link></span>
							</span></div>
					</div>
